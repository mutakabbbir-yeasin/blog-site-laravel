          ...
          <div class="recommended-cards">
            <a href="">
              <div class="recommended-card">
                <img src="{{asset('frontend/images/pic5.jpg')}}" alt="" loading="lazy" />
                <h4>
            ...
            <a href="">
              <div class="recommended-card">
                <img src="{{asset('frontend/images/pushups.jpg')}}" alt="" loading="lazy" />
                <h4>
            ...
            <a href="">
              <div class="recommended-card">
                <img src="{{asset('frontend/images/smoothies.jpg')}}" alt="" loading="lazy" />
                <h4>
                  Healthy Smoothies
                </h4>
              </div>
